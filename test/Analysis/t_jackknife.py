...
class TestJackknife(unittest.TestCase):
    ...
    def testDimensionalities(self):
        ...
        for dim in [1,2,3,4,5,6]:
            ...
            #==================================================
            for ax,N_jak in it.product(range(dim),range(1,10)):
                # create Analysis parameters
                param = tools.analysis.AnalysisParam(tools.analysis.Jackknife,
                    # size of the data we are going to handle
                    data_size = 10,
                    # number of elements removed i.e. leave N_jak out Jackknife
                    N_jak = N_jak, # that's default
                    # use blocking
                    use_blocking = False,
    ...
    def testUniform(self):
        ...
        for N in range(100,500,100):
            ...
            print("done\nBlocking...", end=" ")
            for N_jak,N_blk in it.product(range(1,N), range(2,N//2,10)):
                # blocking
    ...
    def testBinomial(self):
        ...
        """
        for N in range(100,500,100):
            print(f"Testing Estimation of Binomial distribution for a data size of {N}.")
